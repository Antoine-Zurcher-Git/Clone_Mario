...
bouton boutons[] = {//x,y,lx,ly,Dtxt,etat,txt,corX,test,effet,color
  ...
  new bouton(1240, 700, 570, 150, 50, 0, "Crédit", 0, false, 2, color(50)), 
  new bouton(50, 700, 570, 150, 50, 0, "Paramètre", 0, false, 3, color(50)),
  new bouton(1240, 150, 570, 150, 50, 0, "Map Creator", 0, false, 38, color(50)), 
  new bouton(0, 0, -1, -1, 40, 2, "Retour", 0, false, 31, color(50)), 
  new bouton(0, 0, -1, -1, 40, 3, "Retour", 0, false, 32, color(50)), 
  new bouton(0, 0, -1, -1, 40, 8, "Retour", 0, false, 32, color(50)),
  ...
  new bouton(570, 880, 200, 70, 40, 6, "Menu", 0, false, 37, color(50)),
  
  new bouton(150, 500, 350, 120, 40, 8, "Importer", 0, false, 39, color(50)),
  new bouton(1240, 500, 350, 120, 40, 8, "Nouveau", 0, false, 40, color(50))
};
  ...
  void affichageB() {
    if (etat == etatB) {
      ...
      if (testB) {
        ...
        println(xB+mouseX-width/2,yB+mouseY-height/2);
      } else {
...
void effetBouton(int i) {
  if (i > 3 && i < 28+3) {
    ...
    switch(i) {
      ...
      case(39):
      importation = true;
      open = ((String)JOptionPane.showInputDialog(null, "Importation", "Nom du fichier : ", JOptionPane.PLAIN_MESSAGE));;
      open = "mapCreator/"+open;
      passEtat(7);
      break;
      case(40):
      importation = false;
