...
void draw() {//------------------------------------------------------------------DRAW-----------------------------------------------------------------------------------------------
  ...
  for (int i = 0; i < large; i ++) {// block : 30*30
    for (int j = 0; j < haut; j ++) {
      int nmB = numBloc(map[j].charAt(i));
...
int numBloc(char blocF) {//------------------------------------------------------------------NUM BLOC-----------------------------------------------------------------------------------------------
  int a = 0;
  while (blocF != blocs[a]) {
    a ++;
  }
